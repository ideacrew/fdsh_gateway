...
RSpec.shared_context 'family response with invalid address1 for H41 schema', shared_context: :metadata do
  let(:first_address) do
    {
      kind: 'mailing',
      address_1: '742 Washington  sdkjhksdkjsdhdjsdbjdshkjshhdkkhsdhkhdhkjsdhi8wyhiwencjksdnkdskldsnkjndsk Ave, 1',
      state: 'ME',
