...
RSpec.describe Fdsh::Jobs::GenerateTransmittableRidpPrimaryPayload, dbclean: :after_each do
  include_context "family response with one policy"

  subject { described_class.new }
  let(:key) { :ridp_primary_verification_request}
  let(:title) { 'RIDP Primary Request' }
  let(:description) { 'RIDP primary verification request to CMS' }
