...
RSpec.describe Fdsh::Pvc::Medicare::Response::ProcessPvcMedicareDetermination, dbclean: :after_each do
  describe "ProcessPvcMedicareDetermination" do
    let(:mdcr_payload) do
      { :IndividualResponses =>
    ...
    let(:medicare_response) { AcaEntities::Fdsh::Pvc::Medicare::EesDshBatchResponseData.new(mdcr_payload) }
