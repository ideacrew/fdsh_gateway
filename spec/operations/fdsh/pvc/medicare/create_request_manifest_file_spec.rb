...
RSpec.describe Fdsh::Pvc::Medicare::CreateRequestManifestFile do
  ...
  after :all do
    ...
    manifest_from_spec = Dir[Rails.root.join("pvc_request_outbound/SBE00ME.DSH.PVCIN.D*.IN.zip")].max { |f1, f2| File.mtime(f1) <=> File.mtime(f2) }
