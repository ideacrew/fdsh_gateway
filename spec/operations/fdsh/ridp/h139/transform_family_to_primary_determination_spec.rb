...
RSpec.describe Fdsh::Ridp::H139::TransformFamilyToPrimaryDetermination, dbclean: :after_each do
  ...
  before do
    @result = subject.call(family_entity)
    @request = @result.success
  end

  it 'converts the family' do
    expect(@result).to be_success
    expect(@request.is_a?(AcaEntities::Fdsh::Ridp::H139::PrimaryRequest)).to be_truthy
  end
end