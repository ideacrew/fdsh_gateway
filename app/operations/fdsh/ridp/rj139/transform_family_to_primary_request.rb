      ...
      module InitialVerification
        ...
        class TransformFamilyToPrimaryRequest
          ...
          def build_request_entity(person)
            # verify when new operation is available in aca_entities for rj139, the one below does not yet exist
            ::AcaEntities::Fdsh::Ridp::Rj139::Operations::PersonToInitialRequest.new.call(person)
          end
        end
      end
    end
