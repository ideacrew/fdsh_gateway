...
module Fdsh
  module Pvc
    module Medicare
      module Request
        # This class create a Pvc medicare request manifest file
        class CreateManifestFile
          ...
          def call(params)
            ...
            manifest_file              = yield create_manifest_file(pvc_manifest_medicare_xml, values[:outbound_folder])
          ...
          def create_manifest_file(pvc_manifest_medicare_xml, outbound_folder)
