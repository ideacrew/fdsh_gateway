...
module Subscribers
    module Fdsh
        ...
        class RrvMedicaidResponsesSubscriber
          include ::EventSource::Subscriber[amqp: 'fdsh.rrv_medicaid.responses']
          # rubocop:disable Lint/RescueException
          # rubocop:disable Style/LineEndConcatenation
          # rubocop:disable Style/StringConcatenation
          subscribe(:on_fdsh_rrv_medicaid_responses) do |delivery_info, _properties, payload|
